<template>
  <div class="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="text-center max-w-3xl mx-auto">
      <h1 class="text-3xl font-bold mb-4">SEO Tools & Features</h1>
      <p class="text-gray-600 mb-6">Boost your website's visibility with our comprehensive suite of SEO tools</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="tool in seoTools" :key="tool.title" 
           class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
        <div class="h-12 w-12 bg-blue-100 rounded-lg mb-4 flex items-center justify-center">
          <component :is="tool.icon" class="h-6 w-6 text-blue-600" />
        </div>
        <h3 class="font-medium text-lg mb-2">{{ tool.title }}</h3>
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg p-8 text-center text-white">
      <h2 class="text-2xl font-bold mb-4">Ready to improve your SEO?</h2>
      <p class="mb-6 text-blue-100">Start your free trial today and see the difference our tools can make.</p>
      <button class="px-8 py-3 bg-white text-blue-600 rounded-md hover:bg-blue-50">
        Get Started Now
      </button>
    </div>
  </div>
...
const seoTools = [
  {
    ...
    description: 'Find the most valuable keywords for your business',
    features: [
  ...
  },
  {
    title: 'Local SEO',
    icon: MapIcon,
    description: 'Improve your local search presence',
    features: [
