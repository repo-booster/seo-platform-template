<template>
  <div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow">
      <h1 class="text-xl font-semibold mb-4">Site Audit</h1>
      <p class="text-gray-600 mb-4">Analyze your website for technical SEO issues and get actionable recommendations.</p>
    ...
    <div v-if="results" class="space-y-6">
      ...
      <!-- Issues List -->
      <div class="bg-white p-6 rounded-lg shadow">
        <h2 class="text-lg font-medium mb-4">Issues Found</h2>
        <div class="space-y-4">
          <!-- Critical Issues -->
          <div v-if="results.issues.critical > 0" class="p-4 bg-red-50 rounded-lg">
            <h3 class="text-red-700 font-medium mb-2">Critical Issues</h3>
          ...
          <!-- Warnings -->
          <div v-if="results.issues.warnings > 0" class="p-4 bg-yellow-50 rounded-lg">
            <h3 class="text-yellow-700 font-medium mb-2">Warnings</h3>
          ...
          <!-- Notices -->
          <div v-if="results.issues.notices > 0" class="p-4 bg-blue-50 rounded-lg">
            <h3 class="text-blue-700 font-medium mb-2">Notices</h3>
